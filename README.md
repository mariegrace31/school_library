...
```sh
  git clone https://github.com/mariegrace31/school_library.git
  cd school_library
```
...
Feel free to check the <a href="https://github.com/mariegrace31/school_library/issues">issues page</a>
